...
const ClaimsOnMyPostsSection = ({ claims = [], onApprove, onReject }) => {
  if (claims.length === 0) {
    return (
      <div className="dashboard-card p-6 text-center">
        <p className="section-subtitle">No claims on your posts</p>
      </div>
    );
  }
  ...
  return (
    <div>
      <SectionHeader title="Claims on My Posts" showAllLink="/found/mine" />
...
export default ClaimsOnMyPostsSection;
